...
int main(void)
{
    ...
    int codigosDestinos;
    char codigosDestinosTexto[4][4] = {"BRA", "MDQ", "MZA", "BRC"};
    char nombresDestinos[4][30] = {"Brasil", "Mar del Plata", "Mendoza", "Bariloche"};
    float precios[4] = {25000.0, 14000.0, 19000.0, 23000.0};
        ...
        do
        {
            ...
            for (j = 0; j < largo; j++)
            {
                if (dni[i][j] < '0' || dni[i][j] > '9') // Los digitos tiene que estar en 0 y 9.
                {
                    ...
                    dniValido = 0; // Marca invalido, se repite el ciclo.
